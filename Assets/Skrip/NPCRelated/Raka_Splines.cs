...
public class Raka_Splines : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (t >= 0f && SceneControl.InstanceSceneControl.actNow < 19)
        {
            t = 0f;
        }
        else if (t >= 0.3f && SceneControl.InstanceSceneControl.actNow == 19)
        {
            t = 0.3f;

        }
        else if (t >= 0.8f && SceneControl.InstanceSceneControl.actNow == 20)
        {
            t = 0.8f;
        }
        else if (t >= 1f && SceneControl.InstanceSceneControl.actNow == 21)
        {
            t = 1f;
        }
        else
